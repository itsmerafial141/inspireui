...
class DateTimeFormatConstants {
  ...
  static const timeddMMyyyy = 'HH:mm dd/MM/yyyy';
}
...
class DateTimeUtils {
  ...
  static String getTimeAndDay(DateTime dateTime) {
    final dateFormat = DateFormat(DateTimeFormatConstants.timeddMMyyyy);
    return dateFormat.format(dateTime);
  }
  ...
  static DateTime? tryParseDateTime(dynamic data) {
    final runtimeType = data.runtimeType.toString();

    if (runtimeType == 'Timestamp') {
      return data.toDate();
    }
